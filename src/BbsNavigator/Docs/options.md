...
| Preview Multiline Paste | Opens an editable review window before sending multiple clipboard lines. Enabled by default. Pacing overrides can be remembered per board from this window. |
