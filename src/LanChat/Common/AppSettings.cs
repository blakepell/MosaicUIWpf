...
namespace LanChat.Common
{
    ...
    public partial class AppSettings : ObservableObject, IAppSettings
    {
        ...
        [property: Description("Who you will be displayed as on the chat network.")]
        [ObservableProperty]
        [property: Browsable(true)]
        ...
        [property: Description("Gets or sets the network address of the remote chat server.")]
        [ObservableProperty]
        [property: Browsable(true)]
        private string _ipAddress = "127.0.0.1";

        /// <summary>
        /// Gets or sets the port of the remote chat server.
        /// </summary>
        [property: Category("Network")]
        [property: DisplayName("Port")]
        [property: Description("Gets or sets the port of the remote chat server.")]
        [ObservableProperty]
        [property: Browsable(true)]
