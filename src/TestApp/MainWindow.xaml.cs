...
namespace TestApp
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void OnLayoutRootPropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            {
                Debug.WriteLine($"ActiveContent-> {activeContent}");
            }
        }
        ...
        private void OnSwitchTheme(object sender, RoutedEventArgs e)
        {
            ...
            if (menuItem.Tag is not string themeTag)
                return;

            Theme theme;
            switch (themeTag)
            {
                case "Dark": theme = new DarkTheme(); break;
                case "Light": theme = new LightTheme(); break;
                case "Blue": theme = new BlueTheme(); break;
                default: theme = new DarkTheme(); break;
            }
