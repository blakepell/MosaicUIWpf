...
namespace Mosaic.UI.Wpf.Converters
{
    ...
    /// <summary>
    /// Converts a boolean value into a configurable value of type <seealso cref="Visibility"/>.
    /// </summary>
    [ValueConversion(typeof(bool), typeof(Visibility))]
    public sealed class BoolToVisibilityConverter : MarkupExtension, IValueConverter
    {
        /// <summary>
        /// Provides a singleton instance of the <see cref="BoolToVisibilityConverter"/> class.
        /// </summary>
