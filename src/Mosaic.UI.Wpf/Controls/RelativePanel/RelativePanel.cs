namespace Mosaic.UI.Wpf.Controls
{
    ...
    {
        private readonly RelativePanelGraph _mGraph = new();
        ...
        private void GenerateGraph()
        {
            ...
            if (Children.Count > 0)
            {
                _mGraph.AddNodes(Children);
                _mGraph.ResolveConstraints(this);
            }
        }
        ...
        {
            GenerateGraph();
            _mGraph.MeasureNodes(availableSize);
            ...
            // the border.
            return _mGraph.CalculateDesiredSize();
        }
        ...
        {
            _mGraph.ArrangeNodes(new Rect(0, 0, finalSize.Width, finalSize.Height));
            return finalSize;
        }
    }
}
