...
namespace AvalonDock.Controls.Shell.Standard
{
    ...
    internal readonly struct Win32Error : IEquatable<Win32Error>
    {
        ...
        public static Win32Error GetLastError() => new(Marshal.GetLastWin32Error());
    ...
    internal struct HRESULT : IEquatable<HRESULT>
    {
        ...
        [SuppressMessage("Microsoft.Performance", "CA1823:AvoidUnusedPrivateFields")]
        public static readonly HRESULT E_PENDING = new(0x8000000A);
        ...
        [SuppressMessage("Microsoft.Performance", "CA1823:AvoidUnusedPrivateFields")]
        public static readonly HRESULT REGDB_E_CLASSNOTREG = new(0x80040154);
        ...
        [SuppressMessage("Microsoft.Performance", "CA1823:AvoidUnusedPrivateFields")]
        public static readonly HRESULT INTSAFE_E_ARITHMETIC_OVERFLOW = new(0x80070216);
