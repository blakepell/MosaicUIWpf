...
namespace AvalonDock.Controls
{
    ...
    public class LayoutAutoHideWindowControl : HwndHost, ILayoutControl
    {
        ...
        /// <inheritdoc/>
        protected override IEnumerator LogicalChildren => _internalHostPresenter == null ? new UIElement[] { }.GetEnumerator() : new UIElement[] { _internalHostPresenter }.GetEnumerator();
        ...
        private void OnResizerDragCompleted(object sender, DragCompletedEventArgs e)
        {
            ...
            TransformToAncestor(rootVisual);
