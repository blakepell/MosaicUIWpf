...
namespace AvalonDock.Layout
{
    ...
    /// </summary>
    [Serializable]
    public class LayoutAnchorable : LayoutContent, ISerializableLayoutAnchorable
    {
        ...
        public void ToggleAutoHide()
        {
            if (IsAutoHidden)
            {
                ...
                if (((ILayoutPreviousContainer)parentGroup).PreviousContainer is not LayoutAnchorablePane previousContainer)
                {
        ...
        public void ToggleSingleAutoHide()
        {
            if (IsAutoHidden)
            {
                ...
                if (Parent is not LayoutAnchorGroup parentGroup)
                {
                    return;
                }
