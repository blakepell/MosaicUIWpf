...
namespace AvalonDock.Layout
{
    ...
    [Serializable]
    public abstract class LayoutContent : LayoutElement, ILayoutElementForFloatingWindow, IComparable<LayoutContent>, ILayoutPreviousContainer, ISerializableLayoutContent, ISerializablePreviousContainer
    {
        /// <summary>
        ...
        /// <param name="oldValue">The previous value.</param>
        /// <param name="newValue">The new value.</param>
        protected void OnIsSelectedChanged(bool oldValue, bool newValue) => IsSelectedChanged?.Invoke(this, EventArgs.Empty);
        ...
        /// </summary>
        /// <param name="args">The event arguments.</param>
        protected void OnClosing(CancelEventArgs args) => Closing?.Invoke(this, args);
