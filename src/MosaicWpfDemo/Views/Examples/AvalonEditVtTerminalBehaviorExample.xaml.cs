...
{
    public partial class AvalonEditVtTerminalBehaviorExample
    {
        public AvalonEditVtTerminalBehaviorExample()
        {
            this.DataContext = this;
            InitializeComponent();

            this.Loaded += AvalonEditVtTerminalBehaviorExample_Loaded;
        }

        private void AvalonEditVtTerminalBehaviorExample_Loaded(object sender, RoutedEventArgs e)
        {
