...
namespace MosaicWpfDemo.Common
{
    ...
    /// run of the app.  Prefer the <see cref="MosaicTemplateApp.Common.AppViewModel.AppSettings"/> class for settings or state
    /// that needs to be saved and reloaded.
    /// </summary>
    public partial class AppViewModel : ObservableObject
    {
        /// <summary>
        /// A reference to the <see cref="MosaicTemplateApp.Common.AppViewModel.AppSettings"/> for the project so that the application
