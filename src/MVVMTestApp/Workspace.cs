...
namespace AvalonDock.MVVMTestApp
{
	internal class Workspace : ViewModelBase
	{
		...
		protected Workspace()
		{
			...
			{
				new Tuple<string, Theme>(nameof(DarkTheme), new DarkTheme()),
				new Tuple<string, Theme>(nameof(LightTheme), new LightTheme()),
				new Tuple<string, Theme>(nameof(BlueTheme), new BlueTheme()),
			};
